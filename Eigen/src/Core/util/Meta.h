...
// A compile-time set of bools.
template<bool...>
struct bool_set {};

// Reduces a set of bools to true if all are true, false otherwise.
template<bool... values>
using reduce_all = std::is_same<bool_set<values..., true>, bool_set<true, values...> >;

// Reduces a set of bools to true if any are true, false if all false.
template<bool... values>
using reduce_any = std::integral_constant<bool,
    !std::is_same<bool_set<values..., false>, bool_set<false, values...> >::value>;
