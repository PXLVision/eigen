...
void run_serialized(std::index_sequence<Indices...>, std::index_sequence<OutputIndices...>,
  ...
  auto args = Eigen::internal::tuple_impl::tuple<typename std::decay<Args>::type...>(typename std::decay<Args>::type{}...);
  ...
  buff_ptr = Eigen::deserialize(buff_ptr, Eigen::internal::tuple_impl::get<Indices, typename std::decay<Args>::type...>(args)...);
  
  // Call function, with void->Void conversion so we are guaranteed a complete
  // output type.
  auto result = void_helper::call(kernel, Eigen::internal::tuple_impl::get<Indices, typename std::decay<Args>::type...>(args)...);
  
  // Determine required output size.
  size_t output_size = sizeof(size_t);
  output_size += Eigen::serialize_size(Eigen::internal::tuple_impl::get<OutputIndices, typename std::decay<Args>::type...>(args)...);
  ...
  if (output_size <= capacity) {
    ...
    buff_ptr = Eigen::serialize(buff_ptr, Eigen::internal::tuple_impl::get<OutputIndices, typename std::decay<Args>::type...>(args)...);
...
template<typename Kernel, typename... Args, size_t... Indices, size_t... OutputIndices>
auto run_serialized_on_gpu(std::index_sequence<Indices...>, 
  ...
  // Deserialize outputs.
  auto args_tuple = Eigen::internal::tuple_impl::tuple<Args&...>(args...);
