...
void run_serialized(index_sequence<Indices...>, index_sequence<OutputIndices...>,
  ...
  Eigen::Tuple<typename std::decay<Args>::type...> args = Eigen::make_tuple(typename std::decay<Args>::type{}...);
  ...
  if (output_size <= capacity) {
    ...
    buff_ptr = Eigen::serialize(buff_ptr, Eigen::tuple_get<OutputIndices, typename std::decay<Args>::type...>(args)...);
...
auto run_serialized_on_gpu(index_sequence<Indices...>, 
  ...
  host_ptr = Eigen::deserialize(host_ptr, Eigen::tuple_get<OutputIndices, Args...>(args_tuple)...);
